# Food memory — known items & macro estimates

Reference for logging. When Veronika names one of these, use these values so numbers stay
consistent day to day. All values are estimates; refine when a label/photo gives exact numbers.
Add new items as they come up.

| Item | Serving | kcal | protein (g) |
|------|---------|------|-------------|
...
| Mixed kebab doner in pressed pita (heavy white sauce) | 1 portion | 850 | 40 |
...
| Apple | 1 medium (~180 g) | 95 | 0.5 |
| Z bregov Protein chocolate milk | 1 bottle | 230 | 30 |
...
| 3-egg + ham omelette, no cheese, w/ arugula/tomato balsamic garnish | 1 omelette | 320 | 27 |
| Vegan chocolate ice cream scoop | 1 scoop (~65 g) | 130 | 2 |
...
| Vanilla protein vegan milk | 250 ml | 110 | 9 |
